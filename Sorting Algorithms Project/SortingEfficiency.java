...
/**
	@Author - Adam Ryder
	Algorithms 10/20/2013
	Sorting efficiency program.
	This program executes different sorting algorithms
	and times them.

**/
public class SortingEfficiency {

	//swaps two resources in the specified list
	...
	//quicksort with a median of three
	...
	int selcomps = 0;
	int selrec = 0;
	//quicksort with selection sort at n <= 20
	...
	int qComps = 0;
	int qRec = 0;
	//quicksort with Insertion sort at n <= 20
